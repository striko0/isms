...
//					stringBuilder.append("A <b>very</b> long tekst " + t + "");
//					stringBuilder.append("A <b>very</b> long tekst " + t + "");
//					stringBuilder.append("A very long tekst <br/>");
...
//	@PostConstruct
//	public void createComposite(final Composite parent) {
//		Shell s = new Shell(parent.getShell(), SWT.DIALOG_TRIM | SWT.APPLICATION_MODAL);
//		s.setSize(380, 350);
...
//		gd_lblNewLabel.verticalIndent = 2;
...
//		
//		styledText = new StyledText(scrolledComposite, SWT.BORDER | SWT.MULTI | SWT.WRAP);
//		scrolledComposite.setContent(styledText);
//		scrolledComposite.setMinSize(styledText.computeSize(SWT.DEFAULT, SWT.DEFAULT));
//		switch (type){
//		case 1:
//			styledText.setText("1-Vrlo niska (javno)U ovu se razinu ubrajaju otvorene informacije i svi drugi informacijski resursi kojima može pristupiti bilo tko unutar ili izvan organizacije. Primjerice informacije na web stranici organizacije. Informacije nisu osjetljivog karaktera ni za unutarnju ni za vanjsku upotrebu.");
//			break;
//		default:
//			styledText.setText(null);
//		break;
