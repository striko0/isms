...
public class CopyOfNewASKTable extends KTable{
	...
	public static CopyOfNewASKTable m_Table;
	public static CopyOfNewASKTable m_TableAsset;
	public static CopyOfNewASKTable m_TableRisk;
	Label statusLabel;
...
//		comp1.setLayout(new FillLayout());
	...
	public CopyOfNewASKTable(ViewSelected view, Composite parent, KTableSortedModel givenModel,int widht, int height) {
