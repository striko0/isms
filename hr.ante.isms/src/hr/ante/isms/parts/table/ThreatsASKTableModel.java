...
public class ThreatsASKTableModel extends KTableSortedModel {
...
//		setContentAt(2, 12, "Izjave o zaprimanju korisnièkih naziva i zaporki");
		...
		//3 Column
		setContentAt(3, 0, "Vrsta Prijetnje");
...
//		setContentAt(3, 12, "1020 - Papirnati Dokument");
		...
		//4 Column
		setContentAt(4, 0, "Vjerojatnost");
//		setContentAt(4, 1, "201011 - Proces druga razina");
//		setContentAt(4, 2, "201011 - Proces druga razina");
//		setContentAt(4, 4, "201011 - Proces druga razina");
//		setContentAt(4, 3, "201011 - Proces druga razina");
//		setContentAt(4, 5, "201011 - Proces druga razina");
//		setContentAt(4, 6, "201011 - Proces druga razina");
//		setContentAt(4, 7, "401013 - Aplikativni softver");
//		setContentAt(4, 8, "101010 - Programski kod ");
//		setContentAt(4, 9, "101010 - Programski kod ");
//		setContentAt(4, 10, "101010 - Programski kod ");
//		setContentAt(4, 11, "1020 - Papirnati Dokument");
//		setContentAt(4, 12, "1020 - Papirnati Dokument");
