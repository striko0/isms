...
public class CopyOfASKTableContextMenu{
	...
	public CopyOfASKTableContextMenu(KTable table,KTableSortedModel model/*,boolean isFixedCell, String doSomething, int clickedColumn*/)  {
