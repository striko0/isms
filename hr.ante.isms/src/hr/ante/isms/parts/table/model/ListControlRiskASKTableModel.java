...
public class ListControlRiskASKTableModel extends KTableSortedModel {

	private int columnNumber=-1;
	private int rowNumber=0;
	private boolean empty=false;
	private String m_RiskId = "";
	public ListControlRiskASKTableModel m_TableLA;
   ...
   */
	public void readAllFromDB(){
		if (!empty) {
			content = dB.getContentFromDB("view_control_risk",
					"ListControlRiskASKTableModel",m_RiskId);
//			if (content.size() == 4) {
//
...
//			}
			DataFromServer.listControlRiskASKTableModel = this;
			columnNumber = 3;
	...
	public ListControlRiskASKTableModel(String riskId) {
