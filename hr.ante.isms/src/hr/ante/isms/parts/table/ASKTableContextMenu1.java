...
public class ASKTableContextMenu1{
	...
	public ASKTableContextMenu1(KTable table,KTableSortedModel model/*,boolean isFixedCell, String doSomething, int clickedColumn*/)  {
...
//				});
				...
				fixedItemCopy.setText("Copy All");
...
//				ItemSeparator = new MenuItem(m_FixedMenu, SWT.SEPARATOR);
				...
				fixedItemSubItem1.addSelectionListener(new SelectionAdapter() {
					...
					public void widgetSelected(SelectionEvent e) {
						...
						m_SortAction.run(ASSortComparatorISMS.SORT_DOWN);
				...
				fixedItemSubItem2.addSelectionListener(new SelectionAdapter() {
					...
					public void widgetSelected(SelectionEvent e) {
						...
						//m_table.setSelection(null, false);
						m_SortAction.run(ASSortComparatorISMS.SORT_UP);
						//sortOnClick(col, row, new ASSortComparatorISMS(model,col, ASSortComparatorISMS.SORT_UP),ASSortComparatorISMS.SORT_UP, 3);
					}
				});
				...
				fixedItemSubItem3.addSelectionListener(new SelectionAdapter() {
					...
					public void widgetSelected(SelectionEvent e) {
						...
						// implement the sorting when clicking on the header.
						//m_table.setSelection(null, false);
						m_SortAction.run(ASSortComparatorISMS.SORT_NONE);
//						sortOnClick(col, row, new ASSortComparatorISMS(model,col, ASSortComparatorISMS.SORT_NONE),ASSortComparatorISMS.SORT_NONE, 3);
					}
				});
...
/* protected class KTablePasteAction extends Action {
	...
	protected class ASKTableSortAction extends Action {
		...
		public void run(int direction) {
			if (m_table != null && !m_table.isDisposed()) {
					//sortOnClick(m_Col, m_Row, new ASSortComparatorISMS(m_Model,m_Col, ASSortComparatorISMS.SORT_DOWN),ASSortComparatorISMS.SORT_DOWN, 3);
					//sortOnClick(m_Col, m_Row, new ASSortComparatorISMS(m_Model,m_Col, direction),direction, buttonClicked);
