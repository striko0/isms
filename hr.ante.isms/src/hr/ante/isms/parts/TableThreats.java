...
//		comp1.setLayout(new FillLayout());
	...
	public TableThreats(Composite parent, int widht, int height) {
//		super(parent,style);
...
//				| SWT.H_SCROLL | SWTX.FILL_WITH_LASTCOL | SWTX.EDIT_ON_KEY);
		table = new KTable(parent,SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL | SWTX.FILL_WITH_DUMMYCOL);
