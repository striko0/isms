...
public class ASMenu {
	...
	protected MenuItem subItem1;
	protected MenuItem subItem2;
	protected MenuItem subItem3;
    
    
    /**
     * 
     */
    public ASMenu(KTable table, int button) {
        m_table = table;
        createActions();
...
//		subItem2.addSelectionListener(new SelectionListener() {
//
//			@Override
//			public void widgetSelected(SelectionEvent e) {
//				// TODO Auto-generated method stub
...
//		subItem3.addSelectionListener(new SelectionListener() {
//
//			@Override
//			public void widgetSelected(SelectionEvent e) {
//				// TODO Auto-generated method stub
...
//		});
    ...
    protected class ASKTableSortAction extends Action {
		protected ASKTableSortAction() {
			setId("ASKTableSortActionActionHandler");//$NON-NLS-1$
			setEnabled(false);
			setText("Sort");
		}
		public void run() {
