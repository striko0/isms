 ...
 *
 */
public class ASKTableSortOnClick2 extends KTableCellSelectionAdapter {

	KTable m_Table;
	KTableSortComparator m_SortComparator;

	public ASKTableSortOnClick2(KTable table,int col, int row, KTableSortComparator comparator, int direction, int button) {
