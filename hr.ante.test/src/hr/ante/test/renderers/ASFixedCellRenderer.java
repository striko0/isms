 ...
 */
public class ASFixedCellRenderer extends DefaultCellRenderer {
     ...
     */
    public ASFixedCellRenderer(int style) {
        super(style);
        //RAZLIKA U ODNOSU NA ORGINAL
        //
        ...
        if ((m_Style & INDICATION_SORT)!=0 &&  
            ...
            if (indicator!=null) {
               int contentLength = rect.x+11+gc.stringExtent(content.toString()).x;
            	//System.out.println("AAAAAAAAA " + content.toString() + " " + contentLength);
            	x = rect.x+rect.width-8;
            	
            	
//            	/**
//            	 * Postavljanje strelica iza teksta.
//            	 * 
//            	 */
//                
//                if (contentLength<x)
